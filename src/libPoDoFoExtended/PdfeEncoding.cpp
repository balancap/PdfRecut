...
//                      PdfeEncoding data                   //
//**********************************************************//
const unsigned short PdfeEncoding::DocEncoding[256] =
{
    0x0, ' ', ' ', ' ', ' ', ' ', ' ', ' ',
    ' ', 0x9, 0xA, ' ', ' ', 0xD, ' ', ' ',
    ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
...
const char* const PdfeEncoding::StandardEncoding[256] = { _notdef, _notdef,
...
const char* const PdfeEncoding::MacRomanEncoding[256] = { _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
...
const char* const PdfeEncoding::MacExpertEncoding[256] = { _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
...
const char * const PdfeEncoding::WinAnsiEncoding[256] = { _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
    _notdef, _notdef, _notdef, _notdef, _notdef, _notdef,
...
//                        PdfeEncoding                      //
//**********************************************************//
PdfeEncoding::PdfeEncoding()
{
}

std::string PdfeEncoding::FromCodeToName( int code, PdfeEncodingType::Enum enctype )
{
    // Outside limits.
    if( code < 0 || code > 255 ) {
        return std::string();
    ...
    if( enctype == PdfeEncodingType::Standard ) {
        return std::string( PdfeEncoding::StandardEncoding[ code ] );
    }
    else if( enctype == PdfeEncodingType::WinAnsi ) {
        return std::string( PdfeEncoding::WinAnsiEncoding[ code ] );
    }
    else if( enctype == PdfeEncodingType::MacRoman ) {
        return std::string( PdfeEncoding::MacRomanEncoding[ code ] );
    }
    else if( enctype == PdfeEncodingType::MacExpert ) {
        return std::string( PdfeEncoding::MacExpertEncoding[ code ] );
    }
    return std::string();
}

int PdfeEncoding::FromNameToCode( const std::string& name, PdfeEncodingType::Enum enctype )
{
    // Loop on names...
    for( int i = 0 ; i < 256 ; ++i ) {
        if( enctype == PdfeEncodingType::Standard &&
            PdfeEncoding::StandardEncoding[i] &&
            name == PdfeEncoding::StandardEncoding[i] ) {
            return i;
        }
        else if( enctype == PdfeEncodingType::WinAnsi &&
                 PdfeEncoding::WinAnsiEncoding[i] &&
                 name == PdfeEncoding::WinAnsiEncoding[i] ) {
            return i;
        }
        else if( enctype == PdfeEncodingType::MacRoman &&
                 PdfeEncoding::MacRomanEncoding[i] &&
                 name == PdfeEncoding::MacRomanEncoding[i] ) {
            return i;
        }
        else if( enctype == PdfeEncodingType::MacExpert &&
                 PdfeEncoding::MacExpertEncoding[i] &&
                 name == PdfeEncoding::MacExpertEncoding[i] ) {
            return i;
        }
    }
    return -1;
