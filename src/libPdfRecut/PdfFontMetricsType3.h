...
#ifndef PDFFONTMETRICSTYPE3_H
#define PDFFONTMETRICSTYPE3_H
...
class PODOFO_DOC_API PdfFontMetricsType3 : public PdfFontMetrics
{
public:
     ...
     */
    PdfFontMetricsType3( PdfObject* pFont );
    virtual ~PdfFontMetricsType3();
...
private:
     ...
     */
    PdfFontMetricsType3( const PdfFontMetricsType3& metricsObj );

    /** Assignment operator, not implemented.
     */
    PdfFontMetricsType3& operator=( const PdfFontMetricsType3& metricsObj );

private:
    PdfName       m_sName;
    PdfArray      m_bbox;
    PdfArray      m_width;
    PdfArray      m_fontMatrix;
